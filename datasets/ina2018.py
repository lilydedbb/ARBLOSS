...
class LT_Dataset(Dataset):
    ...
    def __init__(self, root, txt, transform=None):
        ...
        classes, cnt = np.unique(self.targets, return_counts=True)
        self.class_cnt = np.zeros(len(classes))
        self.class_cnt[classes] = cnt
...
class iNa2018(object):
    def __init__(self, distributed, root="", batch_size=60, num_works=40):
        ...
        train_txt = "./data/iNaturelist2018/iNaturalist18_train.txt"
        eval_txt = "./data/iNaturelist2018/iNaturalist18_val.txt"
        ...
        self.train_instance = torch.utils.data.DataLoader(
            train_dataset,
            batch_size=batch_size, shuffle=True if self.dist_sampler is None else False,
